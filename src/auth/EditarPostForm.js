...
EditarPostForm = reduxForm({
  form: 'editarPostForm', // a unique identifier for this form
...
const initialState = state => {
  return {
    initialValues: {
      ...
      content: state.editPost.body
    }
  }
}

export default connect(initialState)(EditarPostForm);